...
export function AdoptionsList({
    ...
    return (
        <section className="overflow-hidden rounded-[28px] border border-orange-100/70 bg-white/88 shadow-[0_18px_50px_-34px_rgb(15_23_42/0.28)] dark:border-slate-700/60 dark:bg-slate-950/72">
