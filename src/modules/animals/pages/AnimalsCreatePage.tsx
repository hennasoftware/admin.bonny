...
export function AnimalsCreatePage() {
    ...
    const handleCreate = async (values: AnimalFormState) => {
        ...
        try {
            ...
            setSuccessMessage("Não foi possível cadastrar o animal.");
        } finally {
            ...
            <AdminLayout>
                <main className="min-h-screen bg-linear-to-br from-orange-50 via-white to-orange-100 px-4 py-20 md:px-8 md:py-10 dark:from-gray-950 dark:via-slate-900 dark:to-gray-950">
                    <div className="mx-auto w-full max-w-4xl">
                        ...
                        {successMessage && (
                            <div className="mb-6 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-700 dark:border-emerald-500/20 dark:bg-emerald-500/10 dark:text-emerald-300">
                                {successMessage}
                            </div>
                        )}
